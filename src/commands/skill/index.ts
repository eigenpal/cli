...
// Curated set of popular AI coding tools. Each follows the same skill-folder
// convention `<.tool-root>/skills/<skill-name>/` so the install logic stays
// uniform; only the root differs. Path conventions cribbed from OpenSpec

 ...
 * kubectl convention of falling back to the public service rather than
 * localhost — a fresh `npm install -g @eigenpal/cli && EIGENPAL_API_KEY=… eigenpal status`
 * should "just work" against the hosted Eigenpal service. For local
 * development against your own server, set `EIGENPAL_BASE_URL=http://localhost:3000`.
 */

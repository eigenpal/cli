...
The official CLI for [Eigenpal](https://eigenpal.com) — author and run AI
...
Full per-command reference in [`./docs/`](./docs/). `eigenpal --help` for flags.
Stdout is data, stderr is status. Exit `0` ok, `1` runtime, `2` misuse.
